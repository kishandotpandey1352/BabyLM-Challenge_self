...
#SBATCH --job-name=epoch_5_main10_plain
#SBATCH --output=logs/main10M_plain_5.out
#SBATCH --error=logs/main10M_plain_5.err
#SBATCH --ntasks=1
...
nvidia-smi --loop=1000 > logs/gpu_usage_5.log &
